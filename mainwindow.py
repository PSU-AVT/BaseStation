...
class MainWindow(QtGui.QMainWindow):
	...
	def initUi(self):
		...
		connectToQuadcopterButton.pressed.connect(self.show_connect)
		disconnectFromQuadcopterButton = QtGui.QPushButton('Disconnect')
		disconnectFromQuadcopterButton.pressed.connect(self.conn_mgr.do_disconnect)
		cqLayout.addWidget(connectToQuadcopterButton)
